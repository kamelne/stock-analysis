...
Sub AllStocksAnalysisRefactored()
    ...
    'tickerIndex not necessary and only slows down code
    ...
    For i = 0 To 11
        ...
        'could just use i from for loop instead of tickerIndex and code would run faster also no need to increase tickerIndex
